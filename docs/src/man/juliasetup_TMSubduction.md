...
# define softening law with post-softening strength = 0.05 initial strength
...
# define material thermal and rheological properties
...
# save input file 
# LaMEM.Write_LaMEM_InputFile( model, "subduction_example.dat")

# # set the number of processors
# ProcessorPartFile = run_lamem_save_grid("subduction_example.dat", 4; verbose=true)
