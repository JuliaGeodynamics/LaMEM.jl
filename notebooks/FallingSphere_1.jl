...
# ╔═╡ d2acae58-dd8e-4384-a1a2-0e61d8bedf90
model.Time
...
# ╔═╡ 98542133-c507-4dab-b279-5ae3ddd7d3b7
rm_phase!(model)
...
md"""
It is often useful to plot the initial model setup. You can do this with the `plot_cross_section` function that is made available once the `Plots.jl` package is loaded:
"""

# ╔═╡ fb23a0a3-1485-4726-8b6e-1a810e50ce7a
plot_cross_section(model, field=:phase, y=0.1)
...
Once the simulation is done, you can look at the results using the same `plot_cross_section` function, but by specifying a timestep, which will read that timestep and plot a cross-section though it:
"""
...
plot_cross_section(model, y=0.2, timestep=t, field=:phase, dim=3)	
...
[compat]
GMT = "~1.3.0"
GeophysicalModelGenerator = "~0.5.2"
LaMEM = "~0.2.0"
Plots = "~1.38.16"
PlutoUI = "~0.7.52"
"""
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "b622db3e4a1f456128bd46d3ea9fe2ea2784af8f"
...
git-tree-sha1 = "d181cf85c46b6fefa4b31c4198ab98dcb8d023a8"
...
git-tree-sha1 = "a974a313d52d0ebd2316041d31b9980d4db88f36"
...
git-tree-sha1 = "b90d08a0fbad33899cd7e32042cb879a8d433589"
...
[[deps.LaMEM]]
deps = ["DocStringExtensions", "GeoParams", "GeophysicalModelGenerator", "Glob", "LaMEM_jll", "PETSc_jll", "ReadVTK", "Requires"]
git-tree-sha1 = "89e777db8e238828e79d2e7046fc8e6adbfc0c14"
uuid = "2e889f3d-35ce-4a77-8ea2-858aecb630f7"
version = "0.2.0"

[[deps.LaMEM_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "MPICH_jll", "MPIPreferences", "MPItrampoline_jll", "MicrosoftMPI_jll", "OpenMPI_jll", "PETSc_jll", "TOML"]
git-tree-sha1 = "ca71d4c3b5557b489feb85fa0ceddfe9f72dc151"
uuid = "15d6fa20-f789-5486-b71b-22b4ac8eb1c1"
version = "1.2.4+0"
...
[[deps.MUMPS_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "METIS_jll", "MPICH_jll", "MPIPreferences", "MPItrampoline_jll", "MicrosoftMPI_jll", "OpenBLAS32_jll", "OpenMPI_jll", "PARMETIS_jll", "Pkg", "SCALAPACK32_jll", "SCOTCH_jll", "TOML"]
git-tree-sha1 = "99f5791b81e59aad952d0629b066cde87a1e81f9"
...
git-tree-sha1 = "fe19d43716eb7ef57c97c82e9e25a82ec403ddfd"
...
[[deps.PETSc_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "LazyArtifacts", "Libdl", "METIS_jll", "MPICH_jll", "MPIPreferences", "MPItrampoline_jll", "MUMPS_jll", "MicrosoftMPI_jll", "OpenBLAS32_jll", "OpenMPI_jll", "PARMETIS_jll", "Pkg", "SCALAPACK32_jll", "SCOTCH_jll", "SuiteSparse_jll", "SuperLU_DIST_jll", "TOML"]
git-tree-sha1 = "a6182e59b4c174b847752c4cd70895cfe44fa7a7"
uuid = "8fa3689e-f0b9-5420-9873-adf6ccf46f2d"
version = "3.16.8+0"
...
git-tree-sha1 = "a22577c9ea475b372b4eec71363e7db0e54f919a"
...
[[deps.SuperLU_DIST_jll]]
deps = ["Artifacts", "CompilerSupportLibraries_jll", "JLLWrappers", "LLVMOpenMP_jll", "LazyArtifacts", "Libdl", "METIS_jll", "MPICH_jll", "MPIPreferences", "MPItrampoline_jll", "MicrosoftMPI_jll", "OpenBLAS32_jll", "OpenMPI_jll", "PARMETIS_jll", "TOML"]
git-tree-sha1 = "210cd84e08829d3ba662ad0a2461fefdeee050fd"
uuid = "9a1356b0-3c82-5da3-b77c-7c198e8bd7ab"
version = "8.1.2+0"
